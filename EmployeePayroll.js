...
try{
    let newemployeePayroll = new EmployeePayroll(2,"Meghan",98000,"Female",new Date("03-02-2019"));
...
try{
    let employeePayroll3 = new EmployeePayroll(3,"Mata",99999,"M",new Date("04-21-2018"));
