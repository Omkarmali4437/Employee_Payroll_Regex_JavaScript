var regexname=RegExp('[A-Z]{1}[a-z]{3,}');
var nonzeroregex = RegExp('^[0-9]*[1-9][0-9]*$');
var genderregex = RegExp("^[MF]$");
...
let employeePayroll = new EmployeePayroll(1,"Robin",20000);

console.log(employeePayroll.toString());
try{
    employeePayroll.name="Mark";
    console.log(employeePayroll.toString());
}catch(e){
    console.error(e);
}
...
try{
    let newemployeePayroll = new EmployeePayroll(2,"Meghan",98000,"F",new Date(2015,11,04));
...
try{
    let employeePayroll3 = new EmployeePayroll(3,"Mata",99999,"M",new Date(2017,08,07));
...
try{
    let employeePayroll4 = new EmployeePayroll(4,"Mansi",18000,"F",new Date(2019,10,09),201305,"omkarmali@gmail.com");
